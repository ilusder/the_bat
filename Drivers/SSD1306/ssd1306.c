...
{
    return HAL_I2C_Mem_Write(hi2c, SSD1306_I2C_ADDR, SSD1306_CONTROL, 1, &command, 1, 10);
}
...
void ssd1306_UpdateScreen(I2C_HandleTypeDef *hi2c)
{
    ...
    for (i = 0; i < 8; i++) {
        ...
        HAL_I2C_Mem_Write(hi2c, SSD1306_I2C_ADDR, SSD1306_DATA, 1, &SSD1306_Buffer[SSD1306_WIDTH * i], SSD1306_WIDTH, 100);
    }
}
...
{
    ssd1306_WriteCommand(hi2c, 0xAE);   // Turn off SSD1306 panel
}
